...
function FeaturedWork() {
  return (
    <div>
      <h1 className="mt-6 font-display text-xl font-medium text-night-950 dark:text-cream sm:text-5xl">
        Projects that demonstrate impact
      </h1>

      <div className="mt-16 divide-y divide-night-900/10 dark:divide-night-600/40">
